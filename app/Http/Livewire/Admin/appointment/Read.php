...
class Read extends Component
{
    ...
    protected $listeners = ['appointmentDeleted'];
    ...
    public function render()
    {
        ...
        $instance = getCrudConfig('appointment');
        ...
        return view('livewire.admin.appointment.read', [
            'appointments' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Appointment')) ]);
    }
}
